...
from Model import transfer_learning_model
from Model import simple_mi_dis_model
from Train import mi_dis_train
from Train import transfer_learning_train
...
if __name__ == '__main__':
    ...
    mirna_num, target_num, disease_num, mirna_disease, target_disease, mirna_target, mirna_name, target_name, disease_name = dataset4()
    ...
    print("miRNA-disease:{}  target-disease:{}  miRNA-target:{}".format(len(mirna_disease[0]), len(target_disease[0]),
                                                                        len(mirna_target[0])))
    print("Sparsity of miRNA-target associated data: {:.6f}\n".format(
    ...
    for train_index, test_index in kf.split(edge_data):
        ...
        G = transfer_learning_model.generator(target_num,feat_shape,out_feat)
        D = transfer_learning_model.discriminator(target_num,feat_shape,out_feat)
        ...
        auc = transfer_learning_train.main(mirna_num, target_num, epochs, pro_ZR, pro_PM, alpha, batchSize,
