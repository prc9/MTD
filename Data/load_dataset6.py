...
def dataset6():
    ...
    td = pd.read_excel("../Data/dataset6/ge_dis.xlsx", header=None, names=['target', 'disease'])
    ...
    mt = pd.read_excel("../Data/dataset6/miRTarBase_MTI.xlsx", header=None, names=['mirna', 'target'])
    ...
    md = pd.read_excel("../Data/dataset6/mi_dis.xlsx", header=None, names=['mirna', 'disease'])
