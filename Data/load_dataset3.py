...
def dataset3():
    ...
    td = pd.read_excel("../Data/dataset3/ge_dis.xlsx", header=None, names=['target', 'disease'])
    ...
    mt = pd.read_excel("../Data/dataset3/miRTarBase_MTI.xlsx", header=None, names=['mirna', 'target'])
    ...
    md = pd.read_excel("../Data/dataset3/alldata_v4.xlsx", header=None, names=['mirna', 'disease'])
